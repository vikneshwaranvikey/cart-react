            ...
            <div className='md:flex justify-between max-w-7xl mx-auto'>
                ...
                <div className='md:flex space-x-28'>
                    <div className={`md:block${click ? "block" : "hidden"}`} >
                        <Input className='font-bold text-base mx-auto w-96 h-10' onChange={handleSearch} value={searchTerm} suffix={<SearchOutlined className='text-red-500 text-xl' />} placeholder="What do you want to buy today?" type="text" />
                    </div>
                    <div className={`flex md:block justify-end ${click ? "block" : "hidden"} mt-2`}>
                        <ul className='md:flex md:space-x-8 space-y-4 md:space-y-0 font-semibold'>
                            <li className='animate-pulse bg-red-500 p-1 rounded-lg hover:text-white'><Link to='/'>Home</Link></li>
                            <li>Account</li>
                            <li>WishList</li>
                            <li >Basket</li>
                            <li ><Link to="/AddCart"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 text-red-500 text-sm">
